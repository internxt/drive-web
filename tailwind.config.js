...
module.exports = {
  ...
  variants: {
    ...
    ringColor: ['responsive', 'dark', 'focus-within', 'focus-visible', 'focus', 'hover', 'group-hover'],
    ringOffsetColor: ['responsive', 'dark', 'focus-within', 'focus-visible', 'focus', 'hover', 'group-hover'],
    ringOffsetWidth: ['responsive', 'focus-within', 'focus-visible', 'focus', 'hover', 'group-hover'],
    ringOpacity: ['responsive', 'dark', 'focus-within', 'focus-visible', 'focus', 'hover', 'group-hover'],
    ringWidth: ['responsive', 'focus-within', 'focus-visible', 'focus', 'hover', 'group-hover'],
    rotate: ['responsive', 'hover', 'focus', 'group-hover'],
    borderRadius: ['active', 'hover', 'focus', 'group-hover'],
