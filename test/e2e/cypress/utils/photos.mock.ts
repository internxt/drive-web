...
const mockResults1 = () => {
    cy.intercept('GET', URL_PHOTOS + '/photos/?includeDownloadLinks=true&limit=60&skip=0&status=EXISTS', { //get 1 photo
        statusCode: 200,
...
const mockResultsMultiple = () => {
    cy.intercept('GET', URL_PHOTOS + '/photos/?includeDownloadLinks=true&limit=60&skip=0&status=EXISTS', { //get all photos
        statusCode: 200,
...
const mockPhoto1 = () => {
    ...
    cy.intercept('OPTIONS', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO1.previewId + '/info', {
        statusCode: 200,
    });
    cy.intercept('GET', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO1.previewId + '/info', {
        statusCode: 200,
    ...
    //get photo info
    cy.intercept('OPTIONS', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO1.photoFileId + '/info', {
        statusCode: 200,
    });
    cy.intercept('GET', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO1.photoFileId + '/info', {
        statusCode: 200,
...
const mockPhoto2 = () => {
    //get photo preview info
    cy.intercept('OPTIONS', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO2.previewId + '/info', {
        statusCode: 200,
    });
    cy.intercept('GET', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO2.previewId + '/info', {
        statusCode: 200,
    ...
    //get photo info
    cy.intercept('OPTIONS', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO2.photoFileId + '/info', {
        statusCode: 200,
    });
    cy.intercept('GET', URL_BRIDGE + '/buckets/' + photos_data.BUCKET_ID + '/files/' + photos_data.PHOTO2.photoFileId + '/info', {
        statusCode: 200,
