...
export default function Preferences(): JSX.Element {
  const TABS: {
    ...
    { id: 'account', label: get('views.account.tabs.account.label'), component: AccountTab },
    { id: 'billing', label: get('views.account.tabs.billing.label'), component: BillingTab },
    { id: 'plans', label: get('views.account.tabs.plans.label'), component: PlansTab },
    { id: 'security', label: get('views.account.tabs.security.label'), component: SecurityTab },
  ];
