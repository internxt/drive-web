...
const WorkspaceCard = ({
  ...
  return (
    <button className="w-full px-2 py-3 text-left hover:bg-gray-10" onClick={handleOnClick}>
      <div className="flex w-full flex-row items-center justify-between space-x-2">
        ...
        <div className="h-4 w-4">{isSelected && <Icon color="white" weight="bold" size={16} />}</div>
      </div>
    </button>
  );
};
...
const WorkspaceSelector: React.FC<WorkspaceSelectorProps> = ({ workspaces, onCreateWorkspaceButtonClicked }) => {
  ...
  return (
    <div className="relative mb-2 inline-block w-full">
      <button
        className="w-full justify-center rounded-lg border border-gray-10 bg-gray-5 p-3 text-left"
      ...
      >
        <div className="flex w-full flex-row items-center justify-between space-x-2">
          ...
          <div className="w-4">
            <CaretUpDown color="white" weight="bold" size={16} />
          </div>
        </div>
      </button>
      <div
      ...
      >
        ...
        <div className="overflow-hidden rounded-lg border border-gray-10 bg-gray-5 shadow-xl">
          ...
          <button
            className="w-full rounded-b-lg px-2 py-3 text-left text-sm font-medium leading-4 text-gray-100 hover:bg-gray-10"
