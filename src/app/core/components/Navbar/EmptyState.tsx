  ...
  return (
    <div className="flex h-full flex-col items-center justify-center">
      <div className="relative h-20 w-28">
        <FolderIcon className="absolute left-11 top-0 h-16 w-16 rotate-10 drop-shadow-soft filter" />
        <PdfIcon className="absolute left-2 top-0 h-16 w-16 rotate-10- drop-shadow-soft filter" />
      </div>
