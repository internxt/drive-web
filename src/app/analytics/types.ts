...
export enum AnalyticsTrackActions {
  ...
  ClickedDriveMainDownloadButton = 'Download Button Clicked',
  ClickedDriveActionsDownloadButton = 'Download Button Clicked',
  ...
  ClickedDriveActionsDeleteButton = 'Delete Clicked',
  ClickedDriveMainDeleteButton = 'Delete Clicked',
