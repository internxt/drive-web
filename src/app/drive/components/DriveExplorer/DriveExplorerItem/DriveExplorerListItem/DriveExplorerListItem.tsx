    ...
    >
      ...
      <div className="box-content flex w-1/12 items-center px-3">
        <div className="flex h-10 w-10 justify-center drop-shadow-soft filter">
          ...
          {itemIsShared && (
            <Users className="group-hover:border-slate-50 absolute -bottom-1 -right-2 ml-3 flex h-5 w-5 flex-col items-center justify-center place-self-end rounded-full rounded-full border-2 border-white bg-primary p-0.5 text-white caret-white group-active:border-blue-100" />
          )}
        </div>
      </div>
