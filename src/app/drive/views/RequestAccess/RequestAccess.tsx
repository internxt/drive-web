          ...
          <>
            <div className="flex w-full flex-col items-center rounded-2xl bg-white p-5 text-gray-100 transition-all duration-100 ease-out sm:shadow-subtle-hard">
              ...
              <textarea
                ...
                rows={4}
                className="mt-5 w-full max-w-lg resize-none rounded-6px border border-gray-40 bg-gray-1 p-3 pl-4 outline-none ring-primary ring-opacity-10 focus:border-primary focus:ring-3"
