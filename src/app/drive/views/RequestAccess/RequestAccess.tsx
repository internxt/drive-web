              ...
              {isRequestingAccess && (
                <>
                  <textarea
                    ...
                    rows={4}
                    className="rounded-6px mt-5 w-full max-w-lg resize-none border border-gray-40 bg-gray-1 p-3 pl-4 outline-none ring-primary/10 focus:border-primary focus:ring-3"
