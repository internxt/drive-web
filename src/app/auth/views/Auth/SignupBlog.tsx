      ...
      <div className="flex w-full max-w-lg flex-col items-center space-y-2 pt-10 lg:w-max lg:items-start lg:pt-0">
        <div className="flex w-full flex-col space-y-3 md:flex-row lg:space-y-0 lg:space-x-3">
          <div className="flex w-full">
            <TextInput
              ...
              register={register}
              autoComplete="off"
              minLength={{ value: 1, message: 'Email should not be empty' }}
              error={errors.email}
            />
          </div>
          ...
          <div className="flex w-full">
            <PasswordInput
              ...
              required={true}
              minLength={{ value: 1, message: 'Password should not be empty' }}
        ...
        <div className="flex w-full flex-col items-center space-y-3 lg:flex-row lg:space-y-0 lg:space-x-3">
            ...
            >
              {loading ? (
                ...
                <div className="flex flex-row items-center space-x-1.5 rounded-lg text-white">
                  <span>Get up to 10GB - For free!</span>
                </div>
              )}
            </button>
          </div>
          ...
          <span className="w-full text-xs text-gray-50 sm:text-left">
            <span>By creating an account, you accept</span>{' '}
            <a
