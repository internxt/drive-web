...
export default function Auth(): JSX.Element {
  ...
  const signup = async (data) => {
    ...
    try {
      ...
      setLoading(false);
      //Open app
      window.open('http://localhost:3000/checkout-plan?planId=plan_F7ptyrVRmyL8Gn&mode=subscription', '_parent');
    } catch (err: unknown) {
      if (inline === true) {
  ...
  return (
    <form
      className="flex w-full max-w-lg flex-col items-center space-y-2 px-1 pt-10 md:items-start md:pt-0"
