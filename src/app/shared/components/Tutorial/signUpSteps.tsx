      ...
      content: (
        <div>
          <div onClick={stepOneOptions.onNextStepClicked} className="cursor-pointer">
            <Button variant="primary" className="ml-auto rounded-lg border-4 border-cool-gray-5/75">
            ...
            <div className="absolute right-0 top-0 mr-1 mt-1 h-10 w-40 animate-ping rounded-lg bg-blue-50" />
          </div>
