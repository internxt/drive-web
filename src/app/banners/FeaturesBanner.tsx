...
const FeaturesBanner = ({ showBanner, onClose }: FeaturesBannerProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div
        className={
          'left-1/2 top-1/2 flex h-[450px] w-[1000px] rounded-3xl -translate-x-[50%] -translate-y-[50%] flex-row overflow-hidden justify-between absolute inset-0 bg-center bg-no-repeat bg-cover items-center'
        }
        style={{
          background: bgColor,
        }}
