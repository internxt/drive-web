...
import { THEMES } from 'services/storage-keys';
...
export const THEME_DEFINITIONS: Record<Exclude<Theme, 'light' | 'dark' | 'system'>, ThemeDefinition> = {
  starWars: {
    key: THEMES.STAR_WARS_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
  ...
  halloween: {
    key: THEMES.HALLOWEEN_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['HORROR80'],
  },
  christmas: {
    key: THEMES.CHRISTMAS_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['SECRETSANTA80'],
  },
  superBowl: {
    key: THEMES.SUPERBOWL_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['SUPERBOWL80', 'SPECIALX80', 'REDDIT80', 'IGSPECIAL80'],
  },
  stPatricks: {
    key: THEMES.STPATRICKS_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['STPADDYS80'],
  },
  idManagement: {
    key: THEMES.ID_MANAGEMENT_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['IDENTITY82', 'IDENTITY82AFF'],
  },
  environment: {
    key: THEMES.ENVIRONMENT_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['PLANET85'],
  },
  summer: {
    key: THEMES.SUMMER_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
    promoCodes: ['SUMMER80'],
  },
  anniversary: {
    key: THEMES.ANNIVERSARY_THEME_AVAILABLE_LOCAL_STORAGE_KEY,
