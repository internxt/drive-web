...
import { getPasswordDetails, getSalt } from '../../services/auth.service';
    ...
    <div className="flex flex-col m-10 h-full justify-center">
      ...
      <div className="flex flex-col my-10 items-center">
        ...
        <BaseButton
          ...
          onClick={() => {
            setLoading(true)
            verifyPassword().then((details) => {
              return httpService.post('/api/guest/accept', {
              ...
              setPassword('')
              notificationsService.show(`${err.message || 'Error accepting invitation'}. Please, try again`, ToastType.Error);
            }).finally(() => {
              setLoading(false)
            });
          }}
