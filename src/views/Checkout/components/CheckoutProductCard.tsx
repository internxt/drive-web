...
import { SealPercentIcon, XIcon } from '@phosphor-icons/react';
...
export const CheckoutProductCard = ({
  ...
  const HIDDEN_COUPON_CODES = ['SPECIAL', 'ANTIV', 'SAVE', 'OFFER', 'CIPIAIDISCOUNT','THEFELLASADSOFFER', 'GOTZHAOFFER', 'TFA','REOFFER', 'WEWE','AMIOFFER','VIPOFFER'];
              ...
              {couponCodeData?.codeName ? (
                <div className="flex w-full flex-row justify-between">
                  ...
                  <div className="flex flex-row items-center gap-2">
                    ...
                    >
                      <XIcon size={20} className="text-gray-50" />
                    </button>
                  </div>
                </div>
              ) : (
