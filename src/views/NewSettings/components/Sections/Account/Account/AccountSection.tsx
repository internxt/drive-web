...
import ClearTrashDialog from 'app/drive/components/ClearTrashDialog/ClearTrashDialog';
import { useTranslationContext } from 'app/i18n/provider/TranslationProvider';
import notificationsService, { ToastType } from 'app/notifications/services/notifications.service';
import { Button } from '@internxt/ui';
import { RootState } from 'app/store';
import { useAppDispatch } from 'app/store/hooks';
import { updateUserProfileThunk, userThunks } from 'app/store/slices/user';
...
const AccountSection = ({ changeSection, onClosePreferences }: AccountSectionProps) => {
  ...
  return (
    <Section title={translate('preferences.account.title')} onClosePreferences={onClosePreferences}>
      ...
      <DeleteAccountContainer onClosePreferences={onClosePreferences} />
