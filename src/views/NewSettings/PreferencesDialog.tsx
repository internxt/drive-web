...
import AccountSection from './components/Sections/Account/Account/AccountSection';
import BillingAccountSection from './components/Sections/Account/Billing/BillingAccountSection';
import PlansSection from './components/Sections/Account/Plans/PlansSection';
import SecuritySection from './components/Sections/Account/Security/SecuritySection';
import GeneralSection from './components/Sections/General/GeneralSection';
import BillingWorkspaceSection from './components/Sections/Workspace/Billing/BillingWorkspaceSection';
import MembersSection from './components/Sections/Workspace/Members/MembersSection';
import OverviewSection from './components/Sections/Workspace/Overview/OverviewSection';
import SectionListContainer, { sectionItems } from './components/containers/SectionListContainer';
import { PreferencesDialogProps, Section, SelectSectionProps } from './types/types';
import TeamsSection from './components/Sections/Workspace/Teams/TeamsSection';
import { AccessLogsSection } from './components/Sections/Workspace/Logs/AccessLogsSection';
...
const PreferencesDialog = (props: PreferencesDialogProps) => {
  ...
  useEffect(() => {
    if (currentSectionParams.length > 0) {
      ...
      const subsectionParams = sectionParams.find((subsection) => subsection.subsection === currentSubsectionParams[0]);
      changeSection({ section: sectionParams[0]?.section, subsection: subsectionParams?.subsection });
    } else {
