...
import './RemoveView.scss';

interface RemoveViewProps {
    match?: any
}

interface RemoveViewState {
...
class RemoveView extends React.Component<RemoveViewProps, RemoveViewState> {

  constructor(props: RemoveViewProps) {
    super(props);
  ...
  componentDidMount() {
    ...
    handleChangeRemove = (event: any) => {
      const removeState = this.state.remove;
    ...
    deActivationContainer(): JSX.Element {
      return (<div className="container-register">
