...
import { UrgentCheckoutAccountFields } from '../components/UrgentCheckoutAccountFields';
import { UrgentCheckoutHeader } from '../components/UrgentCheckoutHeader';
import { UrgentCheckoutHero } from '../components/UrgentCheckoutHero';
import { UrgentCheckoutOrderSummary } from '../components/UrgentCheckoutOrderSummary';
import { UrgentCheckoutPaymentSection } from '../components/UrgentCheckoutPaymentSection';
import { OfferCountdownCard } from '../components/OfferCountdownCard';
import { URGENT_CHECKOUT_CARD_CLASSNAME, URGENT_CHECKOUT_VARIANT_IMAGE, UrgentCheckoutVariant } from '../constants';
import { getUrgentCheckoutPlanSummary } from '../utils/getUrgentCheckoutPlanSummary';
...
interface UrgentCheckoutViewProps {
  userInfo: UserInfoProps;
  variant: UrgentCheckoutVariant;
...
const UrgentCheckoutView = ({
...
}: UrgentCheckoutViewProps): JSX.Element => {
  ...
  const planSummary = getUrgentCheckoutPlanSummary(currentSelectedPlan, translate, couponCodeData);
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-screen-xl flex-col gap-10 px-5 py-8 sm:px-8">
        <UrgentCheckoutHeader />
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-12">
          <div className="w-full lg:w-1/2">
            <UrgentCheckoutHero planSummary={planSummary} creativeImage={URGENT_CHECKOUT_VARIANT_IMAGE[variant]} />
          </div>
          <div className="flex w-full flex-col gap-5 pb-10 lg:sticky lg:top-8 lg:w-1/2" ref={userAuthComponentRef}>
            ...
            />
            <div className={`flex flex-col gap-5 p-5 ${URGENT_CHECKOUT_CARD_CLASSNAME}`}>
              <UrgentCheckoutOrderSummary planSummary={planSummary} />
              <UrgentCheckoutAccountFields
...
export default UrgentCheckoutView;
