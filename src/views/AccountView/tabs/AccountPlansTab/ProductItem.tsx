...
const ProductItem = ({ product, plans, characteristics, handlePlanSelection, handlePaymentIndividual, selectedPlanId, currentPlanId, isPaying, isBusiness, handlePaymentTeams }: ProductItemProps): JSX.Element => {
