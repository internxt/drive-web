...
import { PreparingWorkspaceAnimation } from 'components';
...
const App = (props: AppProps): JSX.Element => {
  ...
  const MOBILE_EXCLUDED_PATHS = ['checkout', AppView.BfCheckout, 'new', AppView.Login, AppView.UniversalLinkSuccess];
