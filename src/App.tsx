      ...
      <DndProvider manager={manager}>
        <Router history={navigationService.history}>
          ...
          <Switch>
            ...
            <Redirect from="/d/sh/file/:token([a-z0-9]{20})/:code?" to="/sh/file/:token([a-z0-9]{20})/:code?" />
            <Redirect from="/d/sh/folder/:token([a-z0-9]{20})/:code?" to="/sh/folder/:token([a-z0-9]{20})/:code?" />
