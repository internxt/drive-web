...
export default function Empty({ icon, title, subtitle, action, contextMenuClick }: Readonly<EmptyProps>): JSX.Element {
  ...
  return (
    <div role="none" className="h-full w-full p-8" onContextMenu={contextMenuClick}>
