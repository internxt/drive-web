    ...
    return (
      <Container fluid>
        <Container className="mt-5" style={{ maxWidth: '784px' }}>
          ...
          <Row className="mt-5 payMethods">
            {AvailablePayMethods.map((method) => (
              ...
              >
                <Card>
                  <Card.Header
                    className={this.state.choosedPayMethod === method.component ? 'card-header-selected' : ''}
                  >
                    <h5>
          ...
          <Row className="mt-5">{this.state.choosedPayMethod ? this.state.choosedPayMethod : ''}</Row>
        </Container>
      </Container>
    );
  }
